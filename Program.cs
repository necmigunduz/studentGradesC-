...
int[] sophiaScores = new int[] { 90, 86, 87, 98, 100, 30, 100 };
int[] andrewScores = new int[] { 92, 89, 81, 96, 90, 56, 86 };
int[] emmaScores = new int[] { 90, 85, 87, 98, 68, 71, 68 };
int[] loganScores = new int[] { 90, 95, 87, 88, 96, 63, 98 };

int currentAssignments = sophiaScores.Length;
...
foreach (string name in studentNames)
{
    ...
    Console.WriteLine($"{currentStudent}\t\t{Convert.ToInt32(currentStudentGrade)}\t{currentStudentLetterGrade}");
}
